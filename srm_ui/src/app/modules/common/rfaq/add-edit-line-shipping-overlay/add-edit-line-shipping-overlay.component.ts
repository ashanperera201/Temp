...
@Component({
    ...
    templateUrl: './add-edit-line-shipping-overlay.component.html',
    encapsulation: ViewEncapsulation.None
})
export class AddEditLineShippingOverlayComponent implements OnInit {
    ...
    rfqSupplierPartLineId: string;
    rfqSupplierPartline: RFQSupplierPartLine;
    countryList: any = [];
    cityList: any = [];
    portList: any = [];
    incoTermList: any = [];
    ...
    constructor(@Inject(MAT_DIALOG_DATA) public data,
        public dialogRef: MatDialogRef<AddEditLineShippingOverlayComponent>,
        ...
        this.rfqSupplierPartLineId = data.rfqSupplierPartline.id;
        this.rfqSupplierPartline = data.rfqSupplierPartline;
        ...
        this.frmShipping = this.fb.group({
            ...
            'rfqSupplierPartLineId': [this.rfqSupplierPartLineId]
        });
    }
    ...
    onFormSubmit(form: NgForm): void {
        ...
        this.isSaving = true;
        let countryOrigin: RFQSupplierPartLineCountryOriginModel = new RFQSupplierPartLineCountryOriginModel();
        ...
        countryOrigin.rfqSupplierPartLineId = this.rfqSupplierPartLineId;

        this.rfaqService.saveRFQSupplierPartLineCountryOrigin([countryOrigin]).subscribe((result) => {
            this.dialogRef.close();
            this.isSaving = false;
            ...
            if (countryOrigin.id === '00000000-0000-0000-0000-000000000000') {
                ...
                if (this.rfqSupplierPartline.rfqSupplierPartLineCountryOrigins) {
                    this.rfqSupplierPartline.rfqSupplierPartLineCountryOrigins.push(countryOrigin);
                }
                else {
                    this.rfqSupplierPartline.rfqSupplierPartLineCountryOrigins = [countryOrigin];
                }
                ...
                const data = this.rfqSupplierPartline.rfqSupplierPartLineCountryOrigins.filter(x => x.id === this.dataShip.id);
                const index = this.rfqSupplierPartline.rfqSupplierPartLineCountryOrigins.indexOf(data[0]);
                this.rfqSupplierPartline.rfqSupplierPartLineCountryOrigins[index] = countryOrigin;
