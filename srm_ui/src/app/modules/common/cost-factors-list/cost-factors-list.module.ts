...
import { CostFactorsListComponent } from './cost-factors-list.component';
...
const collaborationRoutes: Route[] = [
    {
        path: '',
        component: CostFactorsListComponent
    }
];

@NgModule({
    declarations: [
        CostFactorsListComponent,
...
export class CostFactorsListModule {
}