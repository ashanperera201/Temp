...
@Component({
    selector: 'add-costfactor-new-list-overlay',
    templateUrl: './add-costfactor-new-list-overlay.component.html',
  
    encapsulation: ViewEncapsulation.None
})
export class AddCostfactorNewListOverlayComponent {
    ...
    result:any={};
    constructor(@Inject(MAT_DIALOG_DATA) public data, public dialogRef: MatDialogRef<AddCostfactorNewListOverlayComponent>,
    ...
    FetchCostFactorList(rfqId: string) {
        ...
        this.costFactorGroupService.getCFGroupSearch(this.costFactorGroupSearchModel).subscribe(result => {
            //console.log(result)
