...
@Component({
    ...
    templateUrl: './edit-new-line-attribute-overlay.component.html',
    encapsulation: ViewEncapsulation.None
})
export class EditNewLineAttributeOverlayComponent {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) public data,
        public dialogRef: MatDialogRef<EditNewLineAttributeOverlayComponent>,
    ...
    onFormSubmit(form: NgForm) {
        ...
        attribute = Object.assign(attribute, form);
            ...
            this.rfqPartLineAttributeService.savePartLineAttribute([this.dataAttr]).subscribe(result => {
