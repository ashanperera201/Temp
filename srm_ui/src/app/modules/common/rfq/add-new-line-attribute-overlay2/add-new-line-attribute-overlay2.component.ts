...
@Component({
    ...
    templateUrl: './add-new-line-attribute-overlay2.component.html',
...
export class AddNewLineAttributeOverlay2Component {
    ...
    constructor(public dialogRef: MatDialogRef<AddNewLineAttributeOverlay2Component>,
        public dialog: MatDialog,
        @Inject(MAT_DIALOG_DATA) public data,
        private fb: FormBuilder,
        private attributeService: AttributeService,
        private attributeGroupService: AttributeGroupService, private rfqPartLineAttributeService: RfqPartLineAttributeService
    ) {
        ...
        this.attributeData.rfqPartLineId=data.rfqPartLineId;
        console.log(data.rfqPartLineId);
    ...
    onFormSubmit(form: NgForm) {
        ...
        attributeViewModel = Object.assign(attributeViewModel, form);
            ...
            attributeViewModel.rfqPartLineId = this.attributeData.rfqPartLineId;
                 ...
                 this.attributeService.SaveAttribute(attributeViewModel).subscribe(result => {
                    ...
                    if (result.success.success == true) {
                        ...
                        if(result.success.statusCode=='2601'){
                          console.log("Duplicate Attribute Group Title cannot be added")
                        }
                       else{
                        console.log('Unable to Add Attribute Group')
                       }
                      }
    ...
    GotoAddValueOverlay() {
        Swal.fire(
            ...
            if (result.isConfirmed) {
                const dialogattributeValueRef = this.dialog.open(AddNewLineAttributeOverlayComponent, { data: { "id": this.attributeData, "rfqId": this.attributeData.rfqId, "rfqPartLineId":this.attributeData.rfqPartLineId,"attributeCategoryTypes": this.attributeCategoryList, "attributeDataTypes": this.attributeDataTypeList, "format": this.attributeData.format,"NewList":this.attributelist ,"context": this.context} });
                //  const dialogTextValueRef = this.dialog.open(AddNewLineAttributeOverlay2Component, { data: { "attributeData": attribute,   "format": attribute.format, "attributeCategoryTypes": this.attributeCategoryList, "attributeDataTypes": this.attributeDataTypeList, ,} });
    ...
    saveRFQHeaderNoList(attributeresult) {
        let rfqLineAttributes: RFQPartLineAttributeModel[] = [];
        let rfqLineAttribute: RFQPartLineAttributeModel = new RFQPartLineAttributeModel();
        rfqLineAttribute.attributeId = attributeresult.id;
        rfqLineAttribute.attributeDataTypeId = attributeresult.dataTypeId;
        rfqLineAttribute.rfqId = attributeresult.rfqId;
        rfqLineAttribute.rfqPartLineId = attributeresult.rfqPartLineId;
        rfqLineAttributes.push(rfqLineAttribute);

         this.rfqPartLineAttributeService.savePartLineAttribute(rfqLineAttributes).subscribe(result => {
            this.isSaved=false;
           this.dialogRef.close();
                        
                        this.context && this.context.fetchRfqLineAttributeData(attributeresult.rfqId, attributeresult.rfqPartLineId);
    ...
    saveRFQHeaderList(attributeresult) {
        ...
        let rfqLineAttribute: RFQPartLineAttributeModel = new RFQPartLineAttributeModel();
        rfqLineAttribute.attributeId = attributeresult.id;
        rfqLineAttribute.attributeGroupId = attributeresult.attributeGroupId;
        rfqLineAttribute.attributeDataTypeId = attributeresult.dataTypeId;
        rfqLineAttribute.rfqId = attributeresult.rfqId;
        rfqLineAttribute.rfqPartLineId = attributeresult.rfqPartLineId;
        rfqLineAttributes.push(rfqLineAttribute);
        //console.log(rfqLineAttributes);
        this.rfqPartLineAttributeService.savePartLineAttribute(rfqLineAttributes).subscribe(result => {
            this.isSaved=false;
            this.dialogRef.close();
            this.context && this.context.fetchRfqLineAttributeData(attributeresult.rfqId, attributeresult.rfqPartLineId);
...
/* fetchRfqPartLineAttributeData() {
    
    /* this.rfqPartLineAttributeService.getRFQPartLineAttributeByRFQId(this.attributeData.rfqId, this.attributeData.rfqPartLineId).subscribe(result => {
