...
@Component({
    selector: 'add-attrlist-line-item-overlay',
    templateUrl: './add-atttrlist-line-item-overlay.component.html',
  
    encapsulation: ViewEncapsulation.None
})
export class AddAttrlinelistItemOverlayComponent {
    ...
    context: AddNewLineAttributeOverlayComponent;
    result:any={};
    ...
    sortData(sort: Sort) {
        ...
        this.fetchReusableAttributeListData(this.rfqId,this.rfqPartLineId);
    }
    ...
    fetchReusableAttributeListData(rfqId: string,rfqPartLineId :string) {
        this.rfqId = rfqId;
        this.attributeGroupSearchModel.rfqId=rfqId;
        this.attributeGroupSearchModel.rfqPartLineId=rfqPartLineId;
        this.attributeService.getNewAttributelineList(this.attributeGroupSearchModel).subscribe(result => {
           //console.log(result);
