...
@Component({
    ...
    templateUrl: './add-new-line-attribute-overlay3.component.html',
    encapsulation: ViewEncapsulation.None
})
export class AddNewLineAttributeOverlay3Component {
    ...
    constructor(public dialogRef: MatDialogRef<AddNewLineAttributeOverlay3Component>,
    ...
    addSelection() {
        ...
        this.attributeService.SaveAttribute(attributeViewModel).subscribe(result => {
            this.dialogRef.close();
            refference.close();
            this.context && this.context.fetchRfqPartLineAttributeData(result.data.rfqId);
    ...
    GotoAddValueOverlay() {
        ...
        const dialogattributeValueRef = this.dialog.open(AddNewLineAttributeOverlayComponent, { data: { "id": this.attributeData, "rfqId": this.attributeData.rfqId, "attributeCategoryTypes": this.attributeCategoryList, "attributeDataTypes": this.attributeDataTypeList, "ifsTableId": this.attributeData.ifsTableId } });
