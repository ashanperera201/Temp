...
@Component({
    ...
    templateUrl: './add-new-line-attribute-overlay4.component.html',
    encapsulation: ViewEncapsulation.None
})
export class AddNewLineAttributeOverlay4Component {
    ...
    constructor(public dialogRef: MatDialogRef<AddNewLineAttributeOverlay4Component>,
    ...
    GotoAddValueOverlay() {
        const dialogattributeValueRef = this.dialog.open(AddNewLineAttributeOverlayComponent,
            {
                data: {
