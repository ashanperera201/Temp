...
@Component({
    selector: 'add-attr-line-item-overlay2',
    templateUrl: './add-attr-line-item-overlay2.component.html',
...
export class AddAttrLineItemOverlay2Component {
   ...
   validateNumberFormat: any = "true";
    ...
    constructor(public dialogRef: MatDialogRef<AddAttrLineItemOverlay2Component>,
        ...
        this.attributeData.rfqPartLineId = data.attributeData.rfqPartLineId;
 ...
 */
    ...
    onFormSubmit(form: NgForm) {
       ...
       // console.log(attributeViewModel);
        ...
        this.attributeData.expectedValue=this.addValue.get('expectedValue').value
            ...
            this.attributeData.rfqId=this.attributeData.rfqId;
            this.attributeData.rfqPartLineId = this.attributeData.rfqPartLineId;
          // console.log(this.attributeData)
            this.rfqPartLineAttributeService.UpdateRFQPartAttribute([this.attributeData]).subscribe(result => {
                this.dialogRef.close();
                this.context && this.context.fetchRfqLineAttributeData(this.attributeData.rfqId, this.attributeData.rfqPartLineId);
    ...
    GotoAddValueOverlay() {
        ...
        this.attributeData.attributeValues=this.addValue.get('attributeValues').value
        this.attributeData.expectedValue=this.addValue.get('expectedValue').value
       const dialogattributeValueRef = this.dialog.open(AddAttrLineItemOverlayComponent, { data: {"id": this.attributeData, "context": this.context,"isPrev":true  } });
