 ...
 */
@Component({
    selector: 'datatableCriticality',
    styleUrls: ['datatableCriticality.component.scss'],
    templateUrl: 'datatableCriticality.component.html',
})
export class DatatableCriticalityComponent implements AfterViewInit {
