...
@Component({
  selector: 'app-normal-reg-list',
  templateUrl: './normal-reg-list.component.html',
  styleUrls: ['./normal-reg-list.component.scss'],
  providers: [DatePipe]
})
export class NormalRegListComponent implements OnInit {
  ...
  filltabledata(data: any) {
    if(localStorage.getItem('dashboardregfilter')!=''){
      this.filterName = localStorage.getItem('dashboardregfilter');
      this.selectedValue = localStorage.getItem('dashboardregfiltersel')? localStorage.getItem('dashboardregfiltersel'):'all';
    ...
    if (data) {
      ...
      data.forEach(element => {
        ...
        // CR date
        if (Number(regformatdate.split("-")[1]) - 1 == 0 && element.hijriSelected == "Y") {
        ...
        // Gosi Date
        if (Number(gosiformatdate.split("-")[1]) - 1 == 0 && element.hijriSelected == "Y") {
        ...
        if (Number(gosiformatdate.split("-")[1]) - 1 == 0 && element.hijriSelected == "N") {
        ...
        // Saudi Date
        if (Number(saudiformatdate.split("-")[1]) - 1 == 0 && element.hijriSelected == "Y") {
        ...
        if (Number(saudiformatdate.split("-")[1]) - 1 == 0 && element.hijriSelected == "N") {
        ...
        // Zakath Date
        if (Number(zakathformatdate.split("-")[1]) - 1 == 0 && element.hijriSelected == "Y") {
        ...
        if (Number(zakathformatdate.split("-")[1]) - 1 == 0 && element.hijriSelected == "N") {
        ...
        this.dataSourceDashboardList.push({
          ...
          city: element.city,
          cr_no: element.cr_no,
          cr_exp_date: element.cr_exp_date,
          ...
          type: element.type ? element.type : 'Normal Supplier',
      ...
      if(localStorage.getItem('dashboardregfilter')!=''){
        this.applyFilter(localStorage.getItem('dashboardregfilter'));
      }
  ...
  selectchange(){
    this.applyFilter(localStorage.getItem('dashboardregfilter')?localStorage.getItem('dashboardregfilter'):'');
  }
  ...
  applyFilter(value) {
    ...
    localStorage.setItem('dashboardregfilter',value?value.trim():'');
    localStorage.setItem('dashboardregfiltersel',this.selectedValue);
  ...
  openRowInfo(position) {
    localStorage.setItem('dashboardclick','register');
    ...
    this.http.get(environment.nodeurl + '/api/template/userDatatableFields?email=' + this.useremail)
      .subscribe(data => {
        if (data) {
          ...
          if (selected.filter(x => x.section == 'Supplier Reg').length > 0) {
            var usersavedcolumns: string[] = selected.filter(x => x.section == 'Supplier Reg')[0].selectedColumns;
  ...
  async saveFields() {
    ...
    templatedto.section = 'Supplier Reg';
