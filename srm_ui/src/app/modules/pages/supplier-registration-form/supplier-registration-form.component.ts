import { Component, Inject, Optional, ViewChild, OnDestroy, OnInit, ViewEncapsulation, Injectable, ElementRef } from '@angular/core';
import { FormGroup, FormControl, AbstractControl, FormBuilder, ValidationErrors, ValidatorFn, Validators, FormGroupDirective, NgForm } from '@angular/forms';
...
import { add, forEach, replace } from 'lodash';
import { environment } from 'environments/environment';
import { Supplier } from 'app/main/Models/Supplier';
import { SupplierFileName } from 'app/main/Models/SupplierFileName';
...
@Component({
  ...
  styleUrls: ['./supplier-registration-form.css'],
  providers: [
...
export class SupplierRegistrationFormComponent implements OnInit, OnDestroy {
  ...
  isSupplierPortalUser: boolean = false;
  ...
  resetForm2Tab1() {
    this.secondFormGroup.get('typeOfOrganizationCtrl').reset();
    this.secondFormGroup.get('typeOfOrganization2Ctrl').reset();
    this.secondFormGroup.get('managerialCtrl').reset();
    this.secondFormGroup.get('technicallCtrl').reset();
    this.secondFormGroup.get('operationsCtrl').reset();
    this.secondFormGroup.get('saudiNationalslCtrl').reset();
    this.secondFormGroup.get('totallCtrl').reset();
    this.secondFormGroup.get('parentcompanyCtrl').reset();
    this.secondFormGroup.get('sistercompanyCtrl').reset();
    this.secondFormGroup.get('ownercompanyCtrl').reset();
  }

  resetForm2Tab2() {
    this.secondFormGroup.get('operatingProfit1Ctrl').reset();
    this.secondFormGroup.get('operatingProfit2Ctrl').reset();
    this.secondFormGroup.get('netIncome1Ctrl').reset();
    this.secondFormGroup.get('netIncome2Ctrl').reset();
    this.secondFormGroup.get('currentAsset1Ctrl').reset();
    this.secondFormGroup.get('currentAsset2Ctrl').reset();
    this.secondFormGroup.get('totalLiable1Ctrl').reset();
    this.secondFormGroup.get('totalLiable2Ctrl').reset();
    this.secondFormGroup.get('totalEquity1Ctrl').reset();
    this.secondFormGroup.get('totalEquity2Ctrl').reset();
  }

  resetForm2Tab3() {
    this.secondFormGroup.get('noOfYearsCtrl').reset();
    this.secondFormGroup.get('ownsPlantEquipCtrl').reset();
    this.secondFormGroup.get('designnCapCtrl').reset();
    this.secondFormGroup.get('finishProdCtrl').reset();
    this.secondFormGroup.get('internalPolicyCtrl').reset();
    this.secondFormGroup.get('registeredOrgCtrl').reset();
    this.secondFormGroup.get('suspendedProj1Ctrl').reset();
    this.secondFormGroup.get('suspendedProj2Ctrl').reset();
  }

  resetForm2Tab4() {
    this.secondFormGroup.get('litigation1Ctrl').reset();
    this.secondFormGroup.get('litigation2Ctrl').reset();
    this.secondFormGroup.get('compliance1Ctrl').reset();
    this.secondFormGroup.get('shareholder1Ctrl').reset();
    this.secondFormGroup.get('shareholder2Ctrl').reset();
    this.secondFormGroup.get('legalAsset1Ctrl').reset();
    this.secondFormGroup.get('legalAsset2Ctrl').reset();
    this.secondFormGroup.get('labour1Ctrl').reset();
    this.secondFormGroup.get('labour2Ctrl').reset();
    this.secondFormGroup.get('environment1Ctrl').reset();
    this.secondFormGroup.get('environment2Ctrl').reset();
    this.secondFormGroup.get('imiInterested1trl').reset();
    this.secondFormGroup.get('imiInterested2trl').reset();
  }

  resetForm2Tab5() {
    this.secondFormGroup.get('hse1Ctrl').reset();
    this.secondFormGroup.get('docuHseCtrl').reset();
    this.secondFormGroup.get('isohealthCtrl').reset();
    this.secondFormGroup.get('envtMgt1Ctrl').reset();
    this.secondFormGroup.get('dedicatedpersCtrl').reset();
    this.secondFormGroup.get('hseNameCtrl').reset();
    this.secondFormGroup.get('hseDesigCtrl').reset();
    this.secondFormGroup.get('statisticCtrl').reset();
    this.secondFormGroup.get('statisticNearCtrl').reset();
    this.secondFormGroup.get('statisticFirstCtrl').reset();
    this.secondFormGroup.get('statisticMediCtrl').reset();
    this.secondFormGroup.get('statisticLostCtrl').reset();
    this.secondFormGroup.get('statisticFatalCtrl').reset();
    this.secondFormGroup.get('statisticEnvtCtrl').reset();
  }

  resetForm2Tab6() {
    this.secondFormGroup.get('qualityPolicy1Ctrl').reset();
    this.secondFormGroup.get('qualityMgtCtrl').reset();
    this.secondFormGroup.get('qualityMgtIsoCtrl').reset();
    this.secondFormGroup.get('qualityResp1Ctrl').reset();
    this.secondFormGroup.get('qualityNameCtrl').reset();
    this.secondFormGroup.get('qualityDesigCtrl').reset();
  }

  resetForm2Tab7() {
    this.secondFormGroup.get('additionalCtrl').reset();
  }
  ...
  public migrateFiles(tempIdOld: string, registerIdNew: string) {
    ...
    // window.location.href = environment.nodeurl + '/api/file/movefiles?tempId=' + tempId + '&registerId='+ registerId;

    // https://localhost:44304/api/file/movefiles?tempId=1200&registerId=700
  ...
  async validtesting(supplierid, category) {

    Swal.fire('Please dont refresh the page. We are still loading!');
    Swal.showLoading();

    let categoryname = this.activatedRoute.snapshot.params.cat;
    this.NeedmoreRole = categoryname.slice(2);
    ...
    this.http.get(environment.nodeurl + '/api/workflow/history?suplierId=' + this.supplierIdforMoreinfo)
      .subscribe(datahis => {
        var historyAction: any = [];
        historyAction = datahis;

        // historyAction.forEach(element => {

        console.log(historyAction[1].status_remark);

        if (historyAction[1].status_remark === 'New - Pending Criticality Matrix' && this.NeedmoreRole == 'srm' && historyAction[0].status_remark === 'Awaiting Clarification from Supplier') {
          // Do nothing
          this.isValid = true;
          console.log('This is a valid link');
          //return this.isValid;
          this.loadNeedmoreData(supplierid, category);

        } else if (historyAction[1].status_remark === 'Awaiting for HSEQ Desktop Audit' && this.NeedmoreRole == 'hseq' && historyAction[0].status_remark === 'Awaiting Clarification from Supplier') {
          // Do nothing
          this.isValid = true;
          console.log('This is a valid link');
          //return this.isValid;
        ...
        } else if (historyAction[1].status_remark === 'Awaiting for SRM Recommendation' && this.NeedmoreRole == 'srm' && historyAction[0].status_remark === 'Awaiting Clarification from Supplier') {
          // Do nothing
          this.isValid = true;
          console.log('This is a valid link');
          //return this.isValid;
        ...
        } else if (historyAction[1].status_remark === 'Awaiting for VP approval' && this.NeedmoreRole == 'vp' && historyAction[0].status_remark === 'Awaiting Clarification from Supplier') {
          // Do nothing
          this.isValid = true;
          console.log('This is a valid link');
          //return this.isValid;
        ...
        } else if (historyAction[1].status_remark === 'Awaiting for GM approval' && this.NeedmoreRole == 'gm' && historyAction[0].status_remark === 'Awaiting Clarification from Supplier') {
          // Do nothing
          this.isValid = true;
          console.log('This is a valid link');
          //return this.isValid;
        ...
        } else if (historyAction[1].status_remark === 'Awaiting for HSEQ Recommendation' && this.NeedmoreRole == 'hseq' && historyAction[0].status_remark === 'Awaiting Clarification from Supplier') {
          // Do nothing
          this.isValid = true;
          console.log('This is a valid link');
          //return this.isValid;
        ...
        } else if (historyAction[1].status_remark === 'Audit Complete' && this.NeedmoreRole == 'hseq' && historyAction[0].status_remark === 'Awaiting Clarification from Supplier') {
          // Do nothing
          this.isValid = true;
          console.log('This is a valid link');
          //return this.isValid;
        ...
        } else if (historyAction[1].status_remark === 'HSEQ to Perform the Audit' && this.NeedmoreRole == 'hseq' && historyAction[0].status_remark === 'Awaiting Supplier response on NCR') {
          // Do nothing
          this.isValid = true;
          console.log('This is a valid link');
          //return this.isValid;
        ...
        } else if (historyAction[1].status_remark === 'Awaiting for Audit dates' && this.NeedmoreRole == 'hseq' && historyAction[0].status_remark === 'Awaiting Clarification from Supplier') {
          // Do nothing
          this.isValid = true;
          console.log('This is a valid link');
          //return this.isValid;
        ...
        } else if (historyAction[1].status_remark === 'Awaiting Bank Details Review' && this.NeedmoreRole == 'trev' && historyAction[0].status_remark === 'Awaiting Clarification from Supplier') {
          // Do nothing
          this.isValid = true;
          console.log('This is a valid link');
          //return this.isValid;
        ...
        } else if (historyAction[1].status_remark === 'Awaiting Bank Details Approval' && this.NeedmoreRole == 'tapp' && historyAction[0].status_remark === 'Awaiting Clarification from Supplier') {
          // Do nothing
          this.isValid = true;
          console.log('This is a valid link');
          //return this.isValid;
          ...
          Swal.fire({
            ...
            window.location.href = environment.clientUrl + ':4450/supplier-registration-form';
          });
        }
  ...
  public async initialwork() {
    ...
    if (supplierid && category == 'tmp') {


      this.istemp = true;
      this.istempFile = true;
      this.supplier.supplier_id = supplierid;
      this.supplierIdforTemp = this.activatedRoute.snapshot.params.id.toString();
      this.savedCategory = 'tmp';
      ...
      this.http.get(environment.nodeurl + '/api/supplier/tempregister?suplierId=' + supplierid)
        .subscribe(data => {
          if (data) {
            // this.http.get(environment.nodeurl + '/api/template/srmsettings').subscribe(dataset => {
            //   var settings = dataset;
            //   this.draftlimit =Number(settings['draftLimit']);
            this.draftlimit = Number(data[0].draftLimit);

            if (data[0] && (Math.abs((new Date().getTime() - new Date(data[0].created_date).getTime()) / (1000 * 3600 * 24)) < this.draftlimit)) {
    ...
    else if(supplierid && category == 'chk'){
      this.disableButton = true;
      this.istemp = true;
      this.istempFile = true;
      this.supplier.supplier_id = supplierid;
      this.supplierIdforTemp = this.activatedRoute.snapshot.params.id.toString();
      this.savedCategory = 'chk';
      ...
      this.http.get(environment.nodeurl + '/api/supplier/tempregister?suplierId=' + supplierid).subscribe(data => {
        if (data) {
          this.draftlimit = Number(data[0].draftLimit);
          this.setValues(data[0]);
    ...
    else if (supplierid && category == 'inv') {
      this.istemp = true;
      this.supplier.supplier_id = 0;
      this.savedCategory = 'inv';


      this.http.get(environment.nodeurl + '/api/supplier/invite?suplierId=' + supplierid)
        .subscribe(data => {
          if (data[0] && (Math.abs((new Date().getTime() - new Date(data[0].create_date_time).getTime()) / (1000 * 3600 * 24)) < 30)) {
            this.setValuesInvite(data[0]);
            this.firstFormGroup.get('supplierNameCtrl').disable();
    ...
    else if (supplierid && category == 'emg') {
      this.istemp = true;
      this.isEmergency = true;
      this.supplier.supplier_id = 0;
      this.savedCategory = 'emg';
      this.http.get(environment.nodeurl + '/api/supplier/emergency?suplierId=' + supplierid)
        .subscribe(data => {
          if (data[0] && (Math.abs((new Date().getTime() - new Date(data[0].create_date_time).getTime()) / (1000 * 3600 * 24)) < 30)) {
            data[0].supplier_name = data[0].emergency_supplier_name;

            if (data[0].cr_exp_date != '') {
              let UTCDate = Date.UTC(new Date(data[0].cr_exp_date).getFullYear(), new Date(data[0].cr_exp_date).getMonth() + 1, new Date(data[0].cr_exp_date).getDate());
              data[0].reg_date = this.datePipe.transform(new Date(UTCDate), "yyyy-MM-dd");
            }

            data[0].supplier_id = 0;
            data[0].hijriSelected = 'N';
            this.getEmerencyPhotos(supplierid.toString());
            this.setValues(data[0]);
            this.firstFormGroup.get('supplierNameCtrl').disable();
            this.firstFormGroup.get('emailCtrl').disable();
    ...
    else if (supplierid && category && category.indexOf('R_') > -1) {
      await this.validtesting(supplierid, category);
      this.r1FileLoaded = true;
      this.isVatFileSelected = true;
      this.isGosiFileSelected = true;
      this.isSaudiFileSelected = true;
      ...
      this.http.get(environment.nodeurl + '/api/supplier/register?suplierId=' + supplierid)
        .subscribe(data => {
          if (data && data[0]) {
            ...
            if(!(data[0].status == 'Awaiting Bank Details Review' || data[0].status == 'Awaiting Bank Details Approval' || data[0].status == 'Approved'
            || data[0].status == 'Awaiting Clarification from Supplier'|| data[0].status == 'Supplier Approved - Awaiting Bank workflow to be triggered')) {
              this.isSupplierPortalUser = true;  
              this.firstFormGroup.disable();
              this.secondFormGroup.disable();          
            }
            ...
            // this.http.get(environment.nodeurl + '/api/file/getNeedmorePhotos').subscribe(
            //   data =>
      ...
      // } else if (this.firstFormGroup.value.supplierNameCtrl == '' || this.firstFormGroup.value.emailCtrl == '') {
      //   this.istempsave = false;
    }
    else {
      this.istempsave = true;
  ...
  public loadNeedmoreData(supplierid, category) {
    this.isNeedmoreInfo = true;
    this.supplierIdforMoreinfo = this.activatedRoute.snapshot.params.id.toString();
    this.NeedmoreRole = category.slice(2);
    if (this.NeedmoreRole == 'trev' || this.NeedmoreRole == 'tapp') {
      this.needmorebankapprover = true;
      this.firstFormGroup.disable();
      this.secondFormGroup.disable();
      this.firstFormGroup.get('stateCtrl').disable();
    }
    // if (this.NeedmoreRole == 'hseq') {
    //   this.needmorehseq = true;
    //   this.firstFormGroup.disable();
    //   this.firstFormGroup.get('stateCtrl').disable();
    // }
    else {
      this.needmorebankapprover = false;
      this.needmorehseq = false;
    }
  ...
  public uploadingFile() {
    ...
    // });
    // this.http.post<any>(environment.nodeurl + '/api/file/upload', formData, {reportProgress: true, observe: 'events'})
    //   .subscribe(event => {
  ...
  async fileUploading(supplierId) {
    ...
    // this.uploader.onBuildItemForm = (fileItem: any, form: any) => {
    //     form.append('supplierid', supplier.supplier_id);
    ...
    // if (!this.istempFile){
    //   this.supplierIdforRegister = supplier.supplier_id.toString();
    //   this.migrateFiles(this.supplierIdforRegister, this.supplierIdforRegister);
    // }
  ...
  async fileUploading2(supplierId, supplierEmail, oldsupplierId, rejectedSupplierId, isEmergency, bothselected, emgsupplierid) {
    ...
    if (this.selectedFiles && this.selectedFiles.length > 0) {
      this.selectedFiles.forEach((f, index) => {
        ...
        if(this.isSupplierPortalUser) {
          formData.append('isSupplierPortalUser', 'true');
        }
      });
    } else {
    ...
    this.http.post<any>(environment.nodeurl + '/api/file/UploadFileQueueSubmit', formData).subscribe(data => {
      ...
      if (!this.isNeedmoreInfo) {
        if (this.isNeedmoreInfo && this.NeedmoreRole != '') {
          Swal.close();
          Swal.fire({
            title: (this.isNeedmoreInfo && this.NeedmoreRole != '') ? "Supplier Application Submitted" : " Supplier Application Submitted",
            ...
            if (result.isConfirmed) {
              ...
              location.replace(environment.clientUrl + ":4450/supplier-registration-form");
  ...
  async creatEmpFileupload() {
    Swal.fire('Please dont refresh the web browser, we are processing your request!');
    Swal.showLoading();

    this.fileUploading(100);
    await this.sleep(20000);

    Swal.close();

    Swal.fire({
      title: "New Supplier Application Submitted",
      html: "<p style='font-size: 18px;'>Your application has been submitted successfully. We'll get back to you soon. Your temporary number is <b>" + '100' + "</b>, kindly use this number for your reference.</p>",
      width: "1200px",
      showCancelButton: false,
      confirmButtonText: `Ok`,
      denyButtonText: `Don't Load`,
      ...
      if (result.isConfirmed) {
        ...
        this.http.get<any>(environment.nodeurl + '/api/email?email=' + 'bilal.rifas@gmail.com' + '&supplierid=' + '100' + '&content=null&category=register').subscribe(async data => {
          // alert("Successfully sent the email to the supplier!");
          // Swal.fire('Successfully sent the email to the supplier!', 'Success');
          if (!this.isNeedmoreInfo) {
            this.http.post<any>(environment.nodeurl + '/api/email/sendsrmmail?roleName=' + 'IMI-SRM Analyst' + '&supplierid=' + '100' + '&content=' + 'new' + '&category=srm', null).subscribe(async data => {
            });
          }
          ...
          //   // icon: "success",
          //   title: "New Supplier Application Submitted",
          //   html: "<p style='font-size: 18px;'>Your application has been submitted successfully. We'll get back to you soon. Your temporary number is <b>" + supplier.supplier_id + "</b>, kindly use this number for future reference.</p>",
          //   width: "800px"
          // })
          // location.reload();
        });

        window.open(environment.clientUrl + '/pages/auth/register-2', '_blank');
        ...
        window.open(environment.clientUrl + '/auth/register-2', '_blank');
      }
    });
  }
  ...
  if (this.NeedmoreRole == 'trev' || this.NeedmoreRole == 'tapp') {
    ...
    if (this.firstFormGroup.controls.titleCtrl.errors && this.firstFormGroup.controls.titleCtrl.errors.required) { this.alertmessage += '• Primary Contact - Title is required \n'; }
    if (this.firstFormGroup.controls.firstNameCtrl.errors && this.firstFormGroup.controls.firstNameCtrl.errors.required) { this.alertmessage += '• Primary Contact - First Name is required \n'; }
    if (this.firstFormGroup.controls.lastNameCtrl.errors && this.firstFormGroup.controls.lastNameCtrl.errors.required) { this.alertmessage += '• Primary Contact - Last Name is required \n'; }
    if (this.firstFormGroup.controls.positionCtrl.errors && this.firstFormGroup.controls.positionCtrl.errors.required) { this.alertmessage += '• Primary Contact - Position is required \n'; }
    if (this.firstFormGroup.controls.emailCtrl.errors && this.firstFormGroup.controls.emailCtrl.errors.required) { this.alertmessage += '• Primary Contact - Email is required \n'; }
    if (this.firstFormGroup.controls.emailCtrl.errors && this.firstFormGroup.controls.emailCtrl.errors.pattern) { this.alertmessage += '• Primary Contact - Email has invalid format \n'; }
    if (this.firstFormGroup.controls.emailCtrl.errors && this.firstFormGroup.controls.emailCtrl.errors.email) { this.alertmessage += '• Primary Contact - Email has invalid format \n'; }
    if (this.firstFormGroup.controls.telephoneNumberCtrl.errors && this.firstFormGroup.controls.telephoneNumberCtrl.errors.required) { this.alertmessage += '• Primary Contact - Telephone No is required \n'; }
    if (this.firstFormGroup.controls.mobileNumberCtrl.errors && this.firstFormGroup.controls.mobileNumberCtrl.errors.required) { this.alertmessage += '• Primary Contact - Mobile No is required \n'; }
    ...
    if (this.NeedmoreRole == 'trev' || this.NeedmoreRole == 'tapp') {
      ...
      if (this.additionalContact1) { //this.firstFormGroup.value.titleCtrl1
        if (this.firstFormGroup.controls.titleCtrl1.value == null || this.firstFormGroup.controls.titleCtrl1.value == '') {
          this.alertmessage += '• Additional Contact 1-Title is required \n ';
        }
        if (this.firstFormGroup.controls.firstNameCtrl1.value == null || this.firstFormGroup.controls.firstNameCtrl1.value == '') {
          this.alertmessage += '• Additional Contact 1-First Name is required \n ';
        }
        if (this.firstFormGroup.controls.lastNameCtrl1.value == null || this.firstFormGroup.controls.lastNameCtrl1.value == '') {
          this.alertmessage += '• Additional Contact 1-Last Name is required \n ';
        }
        if (this.firstFormGroup.controls.positionCtrl1.value == null || this.firstFormGroup.controls.positionCtrl1.value == '') {
          this.alertmessage += '• Additional Contact 1-Position is required \n ';
        }
        if (this.firstFormGroup.controls.emailCtrl1.value == null || this.firstFormGroup.controls.emailCtrl1.value == '') {
        ...
        if (this.firstFormGroup.controls.telephoneNumberCtrl1.value == null || this.firstFormGroup.controls.telephoneNumberCtrl1.value == '') {
          this.alertmessage += '• Additional Contact 1-Telephone No is required \n ';
        }
        if (this.firstFormGroup.controls.mobileNumberCtrl1.value == null || this.firstFormGroup.controls.mobileNumberCtrl1.value == '') {
    ...
    if (this.additionalContact2) {
      if (this.firstFormGroup.controls.titleCtrl2.value == null || this.firstFormGroup.controls.titleCtrl2.value == '') { this.alertmessage += '• Additional Contact ' + this.contactsequence + '-Title is required \n '; }
      if (this.firstFormGroup.controls.firstNameCtrl2.value == null || this.firstFormGroup.controls.firstNameCtrl2.value == '') { this.alertmessage += '• Additional Contact ' + this.contactsequence + '-First Name is required \n '; }
      if (this.firstFormGroup.controls.lastNameCtrl2.value == null || this.firstFormGroup.controls.lastNameCtrl2.value == '') { this.alertmessage += '• Additional Contact ' + this.contactsequence + '-Last Name is required \n '; }
      if (this.firstFormGroup.controls.positionCtrl2.value == null || this.firstFormGroup.controls.positionCtrl2.value == '') { this.alertmessage += '• Additional Contact ' + this.contactsequence + '-Position is required \n '; }
      if (this.firstFormGroup.controls.emailCtrl2.value == null || this.firstFormGroup.controls.emailCtrl2.value == '') { this.alertmessage += '• Additional Contact ' + this.contactsequence + '-Email is required \n '; }
      ...
      if (this.firstFormGroup.controls.telephoneNumberCtrl2.value == null || this.firstFormGroup.controls.telephoneNumberCtrl2.value == '') { this.alertmessage += '• Additional Contact ' + this.contactsequence + '-Telephone No is required \n '; }
      if (this.firstFormGroup.controls.mobileNumberCtrl2.value == null || this.firstFormGroup.controls.mobileNumberCtrl2.value == '') { this.alertmessage += '• Additional Contact ' + this.contactsequence + '-Mobile No is required \n '; }
  ...
  if (this.NeedmoreRole == 'trev' || this.NeedmoreRole == 'tapp') {
    ...
    if (this.thirdFormGroup.controls.termsandconditionCtrl.value != true) { this.alertmessage += '• Please select - I/We agree to abide with all the above-mentioned declarations \n '; }
  ...
  async createSupplierPdf() {
    ...
    // this.http.post<any>(environment.nodeurl + '/api/email/createpdf?roleName=IMI-SRM&supplierid='+46018+'&content='+'21457'+'&category=gmattachement'+'&recommendation='+'test'+'&outcome='+'testoutcome',null).subscribe(data => {
    //   Swal.fire('Successfully saved pdf!', 'success').then((result) => {
    //     // do nothing
  ...
  async creatEmp() {
    ...
    if (this.isFirstSubmitClick == 1) {
      ...
      if (this.dataSourceAll.length > 0) {
        ...
        var changedFields = "";
        var operatingProfit1Value = "";
        var CurrentAsset1Value = "";
        var TotalLiabilities1Value = "";
        
        var TotalEquity1Value = "";
        var supplier: Supplier = new Supplier();

        if (this.isNeedmoreInfo) {
          if(this.isSupplierPortalUser) {
            changedFields = "";
            this.http.post<any>(environment.nodeurl + '/api/supplier/deleteSupplierChangesApproval?supplierID=' + supplierid , null)
                    .subscribe(data => {
            });   
          } else {
            changedFields += this.supplier.supplier_extra;
          }
          ...
          if (!changedFields.includes(',6,')) {
            if(JSON.stringify(this.supplier.supplier_type) != JSON.stringify(this.firstFormGroup.getRawValue().supplierTypeCtrl)){            
              changedFields += '6' + ',';
            }
          }
          ...
          if (!changedFields.includes('<')) {
            if (this.supplier.extension != this.firstFormGroup.value.extCtrl) {
              changedFields += '<' + ',';
            }
          }
          ...
          if (!changedFields.includes('20')) {
            if (this.supplier.operatingProfit1 == 0){
              operatingProfit1Value = "";
           }
            if (operatingProfit1Value != this.secondFormGroup.value.operatingProfit2Ctrl) {
              changedFields += '20' + ',';
            }
          }
          ...
          if (!changedFields.includes('24')) {
            if (this.supplier.currentAsset2 == "0"){
              CurrentAsset1Value = "";
           }
            if (CurrentAsset1Value != this.secondFormGroup.value.currentAsset2Ctrl) {
              changedFields += '24' + ',';
            }
          }
          ...
          if (!changedFields.includes('25')) {
            if (TotalLiabilities1Value != this.secondFormGroup.value.totalLiable1Ctrl) {
              changedFields += '25' + ',';
            }
          }
          ...
          if (!changedFields.includes('26')) {
            if (this.supplier.totalLiable1 == 0){
              TotalLiabilities1Value = "";
           }
            if (TotalLiabilities1Value != this.secondFormGroup.value.totalLiable2Ctrl) {
              changedFields += '26' + ',';
            }
          }
          ...
          if (!changedFields.includes('28')) {
            if (this.supplier.totalEquity2 == "0"){
              TotalEquity1Value = "";
           }
            if (TotalEquity1Value != this.secondFormGroup.value.totalEquity2Ctrl) {
              changedFields += '28' + ',';
            }
          }
          ...
          if (!changedFields.includes(',=,')) {
            if (this.supplier.accountCurrency != this.thirdFormGroup.value.accountCurrencyCtrl) {
              changedFields += '=' + ',';
            }
          }

          // TODO - workaroud for some datefilds values not set properly - Madushan
          changedFields = changedFields.replace("53,", "").replace("q,","").replace("f,","").replace("d,","").replace("c,","").replace("b,","");
        ...
        supplier.supplier_extra = changedFields;
        supplier.draftLimit = "";
        supplier.status = this.supplier.status;
        supplier.isSupplierPortalUser = this.isSupplierPortalUser;
        ...
        this.http.post<any>(environment.nodeurl + '/api/supplier/register', supplier).subscribe(async data => {
          if (data && data > 0) {
            ...
            // var supplierFileName: SupplierFileName = new SupplierFileName();

            // supplierFileName.supplier_id = supplier.supplier_id;
            // supplierFileName.supplier_name =  this.firstFormGroup.getRawValue().supplierNameCtrl;
            // supplierFileName.original_file_name = this.actualFileName;
            // supplierFileName.file_tag = "";
            // if(this.istempFile){
            //   supplierFileName.supplier_type = "temp";
            // }
            // if (!this.istempFile){
            //   supplierFileName.supplier_type = "registered";
            // }

            // this.http.post<any>(environment.nodeurl + '/api/supplier/filename', supplierFileName).subscribe(async data => {
            ...
            if (supplierid) {
              this.supplier.supplier_id = supplierid;
              this.http.delete<any>(environment.nodeurl + '/api/suppliersTemp/' + supplierid)
                .subscribe(data => {
                  const bodyfile = {
                    newsupplierid: supplier.supplier_id.toString(),
            ...
            if (this.isNeedmoreInfo) {
              Swal.fire({
                title: (this.isNeedmoreInfo && this.NeedmoreRole != '') ? "Additionally Requested Information Submitted" : "Additionally Requested Information Submitted",
                html: "<p style='font-size: 18px;'>Your application has been submitted successfully. We'll get back to you soon. Your temporary number is <b> IMI-" + "2022" + "-" + supplier.supplier_id + "</b>, kindly use this number for your reference. Please press okay to confirm!</p></br></br><p style='font-size: 18px;'>For further information please contact: SRM@IMI-KSA.com</p>",
                width: "1200px",
                showCancelButton: false,
                allowOutsideClick: false,
                confirmButtonText: `Ok`
            ...
            if (!this.isNeedmoreInfo) {
              Swal.fire({
                title: (this.isNeedmoreInfo && this.NeedmoreRole != '') ? "Supplier Application Submitted" : "New Supplier Application Submitted",
                html: "<p style='font-size: 18px;'>Your application has been submitted successfully. We'll get back to you soon. Your temporary number is <b> IMI-" + "2022" + "-" + supplier.supplier_id + "</b>, kindly use this number for your reference. Please press okay to confirm!</p></br></br><p style='font-size: 18px;'>For further information please contact: SRM@IMI-KSA.com</p>",
                width: "1200px",
                showCancelButton: false,
                allowOutsideClick: false,
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.firstFormGroup = this._formBuilder.group({
      ...
      waselCtrl: [],
      // reghijri: ['', [ExpiryDateValidator]],
      // reggregory: ['', [ExpiryDateValidator]],
      // gosihijri: ['', [ExpiryGosiDateValidator]],
      // gosigregory: ['', [ExpiryGosiDateValidator]],
      // saudihijri: ['', [ExpirySaudiDateValidator]],
      // saudigregory: ['', [ExpirySaudiDateValidator]],
      // zakathijri: ['', [ExpiryZakathDateValidator]],
      // zakatgregory: ['', [ExpiryZakathDateValidator]]
    ...
    setInterval(() => {
      ...
      if (this.firstFormGroup.value.supplierNameCtrl != '' && this.firstFormGroup.value.emailCtrl != '' && this.isFirstSubmitClick == 0 && !(category && category.indexOf('R_') > -1)) {
        this.updateTempEmp(this.autosave);
      }
    }, 1800000);
  ...
  async setSupplierValues(supplier) {
    ...
    if (supplier.first_name1 == '' || supplier.first_name1 == undefined) {
    ...
    if (supplier.first_name2 == '' || supplier.first_name2 == undefined) {
  ...
  async updateTempEmpTest() {
    Swal.fire('Please dont refresh the page we are processing your request!');
    Swal.showLoading();
    ...
    // Swal.fire({
    //   html: 'Please dont refresh the page we are processing your request! ',
    //   showCancelButton: false,
    //   confirmButtonText: `Ok`,
    //   denyButtonText: `Don't Load`,
    // }).then((result) => {
    //   if (result.isConfirmed) {
    //     this.isWaitDraft = false;
    //   } else if (result.isDismissed) {
    //     location.reload();
    //   }
    // });
    // // Swal.fire('Sucessfully updated and email sent sucessfully', 'Success');


    // setTimeout(() => { this.isWaitDraft = true; }, 600);

    // Swal.hideLoading();
  }

  copyText() {
    // var val = "https://uatsrm.imi-ksa.com:4450/supplier-registration-form/" + this.supplierIdForFile + "/tmp";
    ...
    console.log('clicked');
    var item = "https://uatsrm.imi-ksa.com:4450/supplier-registration-form/" + "/tmp";;
  ...
  updateTempEmp(autosave) {
    if (this.firstFormGroup.value.supplierNameCtrl == '' && this.firstFormGroup.value.emailCtrl == '') {
      this.toast(TYPE.WARNING, false, 'Supplier Name is required   Supplier Email is required');
    } else if (this.firstFormGroup.value.supplierNameCtrl == '') {
      this.toast(TYPE.WARNING, false, 'Supplier Name is required');
    } else if (this.firstFormGroup.value.emailCtrl == '') {
      this.toast(TYPE.WARNING, false, 'Supplier Email is required');
    } else if (this.firstFormGroup.value.supplierNameCtrl != '' && this.firstFormGroup.controls.supplierNameCtrl.status == 'INVALID') {
      this.toast(TYPE.WARNING, false, 'Supplier Name already exists');
    } else if (this.firstFormGroup.value.emailCtrl != '' && (this.firstFormGroup.controls.emailCtrl.errors && this.firstFormGroup.controls.emailCtrl.errors.pattern != undefined && this.firstFormGroup.controls.emailCtrl.errors.pattern)) {
      this.toast(TYPE.WARNING, false, 'Please enter a valid E-mail Address eg : example@exp.com');
    } else if (this.firstFormGroup.value.emailCtrl != '' && (this.firstFormGroup.controls.emailCtrl.errors && this.firstFormGroup.controls.emailCtrl.errors.invalid != undefined && this.firstFormGroup.controls.emailCtrl.errors.invalid)) {
      this.toast(TYPE.WARNING, false, 'Supplier Email already exists');
    } else if (this.firstFormGroup.value.registrationCtrl != '' && this.firstFormGroup.controls.registrationCtrl.status == 'INVALID') {
      this.toast(TYPE.WARNING, false, 'Registration no already exists');
    } else if (this.firstFormGroup.controls.emailCtrl.status != 'INVALID' && this.firstFormGroup.controls.supplierNameCtrl.status != 'INVALID' && (this.firstFormGroup.value.registrationCtrl != '' && this.firstFormGroup.controls.registrationCtrl.status == 'INVALID')) {
      this.executeListingTemp(this.firstFormGroup.value.registrationCtrl, 'R');
    } else if (this.firstFormGroup.controls.emailCtrl.status != 'INVALID' && this.firstFormGroup.controls.supplierNameCtrl.status == 'INVALID') {
      this.executeListingTemp(this.firstFormGroup.value.supplierNameCtrl, 'N');
    } else if (this.firstFormGroup.controls.supplierNameCtrl.status != 'INVALID' && this.firstFormGroup.controls.emailCtrl.status == 'INVALID') {
      this.executeListingTemp(this.firstFormGroup.value.emailCtrl, 'E');
    }
    else {
      if (!this.istempFile) {
        this.isFirstDraftClick = true;
      }
      ...
      if (!this.firstFormGroup.value.hijriGregCtrl) {
        ...
        if (this.firstFormGroup.value.countryCtrl != 'SAUDI ARABIA' || this.firstFormGroup.value.countryCtrl != 'BAHRAIN'
          || this.firstFormGroup.value.countryCtrl != 'KUWAIT' || this.firstFormGroup.value.countryCtrl == 'OMAN'
          || this.firstFormGroup.value.countryCtrl != 'QATAR' || this.firstFormGroup.value.countryCtrl != 'UNITED ARAB EMIRATES') {
          this.isNotGCC = true;
          if (this.firstFormGroup.value.reggregory == null) {
            registerddate = "";
        ...
        saudiddate = saudi_date ? this.datePipe.transform(new Date(saudi_date.year, saudi_date.month, saudi_date.day), "yyyy-MM-dd") : '';
        zakathdate = zakath_date ? this.datePipe.transform(new Date(zakath_date.year, zakath_date.month, zakath_date.day), "yyyy-MM-dd") : '';
        // auditdate = audit_date ? this.datePipe.transform(new Date(audit_date.year, audit_date.month, audit_date.day), "yyyy-MM-dd") : '';
      ...
      var supplier: Supplier = new Supplier();
      // this.saveasdraftid = supplier.supplier_id.toString();
      ...
      supplier.issued_by = this.firstFormGroup.value.issuedByCtrl ? this.firstFormGroup.value.issuedByCtrl : '';
      supplier.web_site = this.firstFormGroup.value.websiteCtrl ? this.firstFormGroup.value.websiteCtrl : '';
      supplier.supplier_type = (this.firstFormGroup.value.supplierTypeCtrl == null || this.firstFormGroup.value.supplierTypeCtrl == '') ? [] : this.firstFormGroup.value.supplierTypeCtrl;
      supplier.country = this.firstFormGroup.value.countryCtrl ? this.firstFormGroup.value.countryCtrl : '';
      supplier.city = this.firstFormGroup.value.stateCtrl ? this.firstFormGroup.value.stateCtrl : '';
      supplier.other_city = this.firstFormGroup.value.otherCityCtrl ? this.firstFormGroup.value.otherCityCtrl : '';
      supplier.po_box = this.firstFormGroup.value.poBoxCtrl ? this.firstFormGroup.value.poBoxCtrl : '';
      ...
      if (this.additionalContact1) {
        ...
        supplier.first_name1 = this.firstFormGroup.value.firstNameCtrl1 ? this.firstFormGroup.value.firstNameCtrl1 : '';
        supplier.last_name1 = this.firstFormGroup.value.lastNameCtrl1 ? this.firstFormGroup.value.lastNameCtrl1 : '';
        if(this.firstFormGroup.value.emailCtrl1){
          supplier.email1 = this.firstFormGroup.getRawValue().emailCtrl1 ? this.firstFormGroup.getRawValue().emailCtrl1 : this.firstFormGroup.value.emailCtrl1;          
        } else {
          supplier.email1 = "";
        }
      ...
      if (this.secondFormGroup.value.statisticCtrl == 'No') {
        this.fileToRemove = 'h6';
      } else {
        this.fileToRemove = '';
      }

      this.http.post<any>(environment.nodeurl + '/api/supplier/tempregister', supplier).subscribe(async data => {
        ...
        if (data && data > 0) {
          ...
          supplier.supplier_id = data;
          this.supplier.supplier_id = data;
          this.supplier_id = data;
          this.supplierIdforTemp = data;
          this.savedCategory = 'tmp';

          this.supplier.supplier_name = supplier.supplier_name;
          this.supplier.email = supplier.email;
          this.supplier.cr_no = supplier.cr_no;

          this.getPhotos();

          this.istempFile = true;

          // this.http.get<any>(environment.nodeurl + '/api/email?email=' + supplier.email + '&supplierid=' + supplier.supplier_id + '&content=null&category=draft').subscribe(data => {
          ...
          if (this.selectedFiles && this.selectedFiles.length > 0) {
            ...
            this.selectedFiles.forEach((f, index) => {
              ...
              formData.append('supplierid', supplier.supplier_id.toString());

              formData.append('email', supplier.email);

              formData.append('filenames', this.selectedFileName[index]);

              formData.append('emgsupplierid', emgsupplierid);

              formData.append('isEmergency', this.isEmergency.toString());

              formData.append('bothselected', bothselected);

              formData.append('fileToRemove', this.fileToRemove);
          ...
          this.http.post<any>(environment.nodeurl + '/api/file/UploadFileQueueTemp', formData).subscribe(data => {
            var responseonqueue = data;

            if (this.rejectedSupplierId > 0) {
              this.supplierIdforRegister = supplier.supplier_id.toString();
              this.migrateRejectedFiles(this.rejectedSupplierId.toString(), this.supplierIdforRegister, 'tmp');
            }

            this.link = environment.clientUrl + ":4450/supplier-registration-form/" + supplier.supplier_id + "/tmp";
            console.log('clicked');
            var item = this.link;
            this.selectedFiles = [];
            ...
            if (!autosave) {
              Swal.fire({
                html: "<p style='font-size: 18px;'>Thank you for filling the Supplier Registration application. Your application request is saved as draft with a temporary Registration number <b> IMI-" + "2022" + "-" + supplier.supplier_id + "</b>, kindly use this number for your reference. Please use the temporary registration link sent to your email address to complete the registration request.</p></br><p style='font-size: 18px;'>Kindly note that your application is saved as draft. Once your resume your application, you can fill-out the remaining required information. </p></br><p style='font-size: 18px;'>For further information please contact: SRM@IMI-KSA.com</p></br>",
                width: "1200px",
                showCancelButton: false,
                showDenyButton: true,
                confirmButtonText: `Ok`,
                allowOutsideClick: false,
                denyButtonText: `Copy Save as draft link`,
                customClass: {
                  confirmButton: 'order-2',
                  denyButton: 'order-1 deny-class',
                }
              }).then(async (result) => {
                if (result.isConfirmed) {
                  if (this.isFirstDraftClick) {
                    ...
                    //location.replace(environment.clientUrl + ":4450/supplier-registration-form/" + supplier.supplier_id + "/tmp");
  ...
  onQualityChange(ob, cat) {
    ...
    if (cat == 'resp' && selectedBook == 'Yes') {
      ...
      this.secondFormGroup.get('qualityNameCtrl').markAsTouched();
      this.secondFormGroup.get('qualityNameCtrl').setErrors({ invalid: true });

      this.secondFormGroup.get('qualityDesigCtrl').markAsTouched();
      this.secondFormGroup.get('qualityDesigCtrl').setErrors({ invalid: true });
    }
  ...
  openModal(action, obj) {
    ...
    */
    ...
    //   if(this.url.includes('application/pdf')){
    //     console.log('contains pdf');
    //     // this.isPdf = true;

    //   }

    //   if(this.url.includes('application/octet-stream')){
    //     console.log('contains octet');
    //     // this.isDoc = true;

    //   }

    //   if(this.url.includes('application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')){
    //     console.log('contains excel');
    //     // this.isExcel = true;

    //   }

    //   if(this.url.includes('image/png')){
    //     console.log('contains png');
    //     // this.isImage = true;

    //   }

    //   if(this.url.includes('image/jpeg')){
    //     console.log('contains jpeg');
    //     // this.isImage = true;

    //   }

    //   if(this.url.includes('image/gif')){
    //     console.log('contains gif');
    //     // this.isImage = true;
        ...
        if (data != null && data['status'] != 'Reactivated') {
          if (category == 'E') {
            if (addCategory == 'EA1') {
              ...
              this.additionalEmailCheck2 = true;
            } else if (addCategory == 'R1') {
              this.additionalEmailCheck2 = true;
            } else if (addCategory == 'R2') {
              this.additionalEmailCheck2 = true;
            }
          }
        }
  ...
  executeListing(value: string, category: string) {
    ...
    if (value != '' && !(value == 'Sooae.cho@imi-ksa.com' || value == 'muhammed.nauman@imi-ksa.com' || value == 'Nadun.Ruchiranga@xitricon.com' || value == 'chathurya.heshani@xitricon.com' || value == 'uresha.sewwandi@xitricon.com')) {
      ...
      this.http.post<any>(environment.nodeurl + '/api/supplier/isexistsWithStatus', isExist).subscribe(data => {
        ...
        if (data != null && data['status'] == 'EMG'){
          if (category == 'N') {
            this.isnameexists = true;
            this.firstFormGroup.get('supplierNameCtrl').setErrors({ alreadyEmg: true });
          } else if (category == 'E') {
            this.isemailexists = true;
            this.firstFormGroup.get('emailCtrl').setErrors({ alreadyEmg: true });
          } else if (category == 'R') {
            this.iscrnoexists = true;
            this.firstFormGroup.get('registrationCtrl').setErrors({ alreadyEmg: true });
          }
        }
        else if (data != null && data['status'] == 'INV'){
          if (category == 'N') {
            this.isnameexists = true;
            this.firstFormGroup.get('supplierNameCtrl').setErrors({ alreadyInvite: true });
          } else if (category == 'E') {
            this.isemailexists = true;
            this.firstFormGroup.get('emailCtrl').setErrors({ alreadyInvite: true });
          }
        }
        else if (data != null && data['status'] == 'Draft') {
          var alteredregistrationvalue = '';
          var newvalue = '';
          var oldvalue = '';
          var title = '';
          if (category == 'N') {
            ...
            title = 'Company Certificate/Licence/CR#';
          }
          if (!(this.isrejectalreadyloaded && newvalue == oldvalue)) {
            Swal.fire({
              title: 'The registration request with the entered '+title+' already exists in the draft state!!',
              html: '<span style="float:left; color: #7367f0;"><b>If you want to see the information, Please click here to see already existing <u><a href="'+environment.clientUrl+':4450/supplier-registration-form/'+data['supplieR_ID']+'/chk'+'" target="_blank">'+newvalue+',</a></u></b></span></br><span style="float:left;"><b>To continue register with save as draft information, please press – Yes</b></span></br><span style="float:left;"><b>To continue register with different supplier name, saved supplier is not my company, please press - No</b></span>',
              // icon: 'question',
              width: "800px",
              ...
              if (result.isConfirmed) {
                ...
                this.http.post<any>(environment.nodeurl + '/api/supplier/existingsupplierdata', isExist).subscribe(async data => {
                  if(data){
                    this.supplierIdforTemp = data[0].supplier_id;
                    // this.setValues(data[0]);
                    // this.rejectedSupplierId = data[0].revisionNo;
                    ...
                    // await this.http.get(environment.nodeurl + '/api/file/getDraftPhotos?supId=' + this.supplierIdforTemp).subscribe(async data2 => {
                    //   if(data2){
                    //     this.photos = data['photos'];
                    //   }
                    // }); 

                    var url = environment.clientUrl+':4450/supplier-registration-form/'+this.supplierIdforTemp+'/tmp';
                ...
                if (category == 'N') {
                  this.firstFormGroup.patchValue({
                    supplierNameCtrl: value         // supplierNameCtrl: ''
                  });
                } else if (category == 'E') {
                  this.firstFormGroup.patchValue({
                    emailCtrl: value                // emailCtrl: ''
                  });
                } else if (category == 'R') {
                  this.firstFormGroup.patchValue({
                    registrationCtrl: value         // registrationCtrl: ''
                  });
                } else if (category == 'G') {
                  this.firstFormGroup.patchValue({
                    registrationCtrl: value         // registrationCtrl: ''
          ...
          if (category == 'N') {
            ...
            this.iscrnoexists = false;
            this.firstFormGroup.get('registrationCtrl').markAsUntouched();
            alteredregistrationvalue = this.firstFormGroup.getRawValue().registrationCtrl;
            oldvalue = this.supplier.cr_no;
          }
          if (!(this.isrejectalreadyloaded && newvalue == oldvalue)) {
            Swal.fire({
            ...
            newvalue = "";
            alteredregistrationvalue = this.firstFormGroup.getRawValue().registrationCtrl;
            alteredregistrationvalue = oldvalue + alteredregistrationvalue;
          }
        }
        else if (data != null && data['status'] == 'Activated') {
          var newvalue = '';
          var oldvalue = '';
          if (category == 'N') {
            this.isnameexists = false;
        ...
        else if (data != null && data['status'] != 'Reactivated' && data['status'] != 'Draft' && data['status'] != 'INV' && data['status'] != 'EMG') {
          if (category == 'N') {
            this.isnameexists = true;
  ...
  executeListingTemp(value: string, category: string) {
    ...
    if (value != '' && !(value == 'Sooae.cho@imi-ksa.com' || value == 'muhammed.nauman@imi-ksa.com' || value == 'Nadun.Ruchiranga@xitricon.com' || value == 'chathurya.heshani@xitricon.com' || value == 'uresha.sewwandi@xitricon.com')) {
      ...
      this.http.post<any>(environment.nodeurl + '/api/supplier/isexistsWithStatus', isExist).subscribe(data => {
        if (data != null && data['status'] != 'Reactivated' && data['status'] != 'Draft') {
          if (category == 'N') {
            this.isnameexists = true;
            this.firstFormGroup.get('supplierNameCtrl').setErrors({ invalid: true });
            this.toast(TYPE.WARNING, false, 'Supplier Name already exists');
        ...
        else if (data != null && (data['status'] == 'Reactivated' || data['status'] == 'Draft')) {
          var newvalue = '';
          var oldvalue = '';
          if (category == 'N') {
            this.isnameexists = false;
  ...
  onKeySearchIbanSubmit() {
    if (this.thirdFormGroup.value.bankCountryCodesCtrl != '' && this.thirdFormGroup.value.bankCountryCodesCtrl != undefined) {
      var countrycode = this.originalCountryList.filter(x => x.description == this.thirdFormGroup.value.bankCountryCodesCtrl)[0].countryCode;
  ...
  onKeySearchBicSubmit() {
    if (this.thirdFormGroup.value.swiftCtrl != '' && this.thirdFormGroup.value.swiftCtrl != undefined ) {
      if (this.supplier_id == 0) {
...
export const URLValidator: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  // var regxWebPattern = new RegExp(/^((http(s)?:\/\/)(www|WWW)\.)((?!-)[a-zA-Z0-9-\.)]{2,64})+(\.[a-zA-Z]{2,})([\/a-zA-Z0-9])+$/);
  // var regxWebPattern = new RegExp(/^((https?|http):\/\/)?(www.)?(([a-z0-9]+[a-z0-9-\.]+[a-z0-9]){2,63})+\.([a-z]{2,})+(\/[a-zA-Z0-9#]+\/?)*$/);
  // var regxWebPattern = new RegExp(/^((https?|http):\/\/)?(www.)(([a-z0-9]+[a-z0-9-\.]+[a-z0-9]){2,63})+\.([a-z]{2,})+(\/[a-zA-Z0-9-`!@#$%^&*()_+=\[\]{};'\|,<>?~\.]+\/?)*$/);
  var regxWebPattern = new RegExp(/^((https?|http):\/\/)?((www)\.)((?!.*\-\-)(?!.*\-.+\-.*\-)(?!-)[a-z0-9]+[a-z0-9-\.]+[a-z0-9]{1,63})+\.([a-z]{2,})+(\/[a-zA-Z0-9-`!@#$%^&*()_+=\[\]{};'\|,<>?~\.]+\/?)*$/);
...
export const ExpYesNoValidator: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (suspendedprj.value == 'Yes' && (suspendedprj2.value == '' || suspendedprj2.value == undefined)) {
    return { suspend: true };
  }
  return null;
}
...
export const LegalYesNoValidator: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (litigation1.value == 'Yes' && (litigation1re.value == '' || litigation1re.value == undefined)) {
...
export const LegalYesNoValidator2: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (litigation2.value == 'Yes' && (litigation2re.value == '' || litigation2re.value ==  undefined )) {
...
export const LegalYesNoValidator3: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (litigation3.value == 'Yes' && (litigation3re.value == '' || litigation3re.value ==  undefined )) {
...
export const LegalYesNoValidator4: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (litigation4.value == 'Yes' && (litigation4re.value == '' || litigation4re.value ==  undefined )) {
...
export const LegalYesNoValidator5: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (litigation5.value == 'Yes' && (litigation5re.value == '' || litigation5re.value ==  undefined )) {
...
export const LegalYesNoValidator6: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (litigation6.value == 'Yes' && (litigation6re.value == ''|| litigation6re.value ==  undefined)) {
    return { litierror6: true };
  }
  if (litigation6.value == 'Yes' && litigation6re.value != '' && litigation6re.value !=  undefined) {
    return null
  }
...
export const HealthYesNoValidator: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (dedicate.value == 'Yes' && (hsename.value == '' || hsename.value == undefined )) {
...
export const HealthYesNoValidator2: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (dedicate.value == 'Yes' && (hsedes.value == '' || hsedes.value == undefined )) {
...
export const HealthYesNoValidator3: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (static1.value == 'Yes' && (near.value == '' || near.value == undefined)) {
    return { near: true };
  }
  if (static1.value == 'Yes' && near.value != '' && near.value != undefined) {
    return null;
...
export const HealthYesNoValidator4: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (static1.value == 'Yes' && (first.value == '' || first.value == undefined)) {
    return { first: true };
  }
  if (static1.value == 'Yes' && first.value != '' && first.value != undefined) {
    return null;
...
export const HealthYesNoValidator5: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (static1.value == 'Yes' && (medi.value == '' || medi.value == undefined)) {
    return { medi: true };
  }
  if (static1.value == 'Yes' && medi.value != '' && medi.value != undefined) {
    return null;
...
export const HealthYesNoValidator6: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (static1.value == 'Yes' && (lost.value == '' || lost.value == undefined)) {
    return { lost: true };
  }
  if (static1.value == 'Yes' && lost.value != '' && lost.value != undefined) {
    return null;
...
export const HealthYesNoValidator7: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (static1.value == 'Yes' && (fatal.value == '' || fatal.value == undefined)) {
    return { fatal: true };
  }
  if (static1.value == 'Yes' && fatal.value != '' && fatal.value != undefined) {
    return null;
...
export const HealthYesNoValidator8: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  ...
  if (static1.value == 'Yes' && (inci.value == ''|| inci.value == undefined)) {
    return { inci: true };
  }
  if (static1.value == 'Yes' && inci.value != '' && inci.value != undefined) {
    return null;
