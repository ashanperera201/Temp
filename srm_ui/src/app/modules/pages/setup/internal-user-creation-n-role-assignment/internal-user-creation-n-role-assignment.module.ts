...
const internalUseRoutes: Route[] = [
    {
        path: '',
        component: InternalUserCreationNRoleAssignmentComponent
    },
...
@NgModule({
    declarations: [
        InternalUserCreationNRoleAssignmentComponent,
    ],
    imports: [
        RouterModule.forChild(internalUseRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatFormFieldModule,
        MatIconModule,
