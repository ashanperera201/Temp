...
import { block_suppliers1Component } from './block_suppliers1.component';
...
const formRoutes: Route[] = [
    {
        path     : '',
        component: block_suppliers1Component
    }
];

@NgModule({
    declarations: [
        block_suppliers1Component,
    ],
    imports: [
...
export class block_suppliers1Module
{
}
