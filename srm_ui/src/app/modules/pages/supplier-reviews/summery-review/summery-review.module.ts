...
import { SummeryReviewComponent } from './summery-review.component';

const summeryReviewRoutes: Route[] = [
    {
        path: '',
        component: SummeryReviewComponent,
    },
];

@NgModule({
    declarations: [SummeryReviewComponent],
    imports: [
        RouterModule.forChild(summeryReviewRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatFormFieldModule,
        MatIconModule,
...
export class SummeryReviewModule {}
