...
import { ItemsEmergencySupplierInnerComponent } from './items-emergency-supplier-inner.component';
...
const itemsEmergencySupplierInnerRoutes: Route[] = [
    {
        path: '',
        component: ItemsEmergencySupplierInnerComponent
    },
];

@NgModule({
    declarations: [
        ItemsEmergencySupplierInnerComponent,
    ],
    imports: [
...
export class ItemsEmergencySupplierInnerModule {
}