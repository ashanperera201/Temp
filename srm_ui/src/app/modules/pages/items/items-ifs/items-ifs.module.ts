...
import { ItemsIfsComponent } from './items-ifs.component';
...
import { DialogBoxComponent } from '../items-ifs-edit/dialog-box/dialog-box.component';

const itemsKpiRoutes: Route[] = [
    {
        path     : '',
        component: ItemsIfsComponent,
    }
];
