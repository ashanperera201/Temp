...
import { ItemsIfsUpdatedHistoryComponent } from './items-ifs-updatedhistory.component';
...
const itemsEmergencySupplierInnerRoutes: Route[] = [
    {
        path: '',
        component: ItemsIfsUpdatedHistoryComponent
    },
];

@NgModule({
    declarations: [
        ItemsIfsUpdatedHistoryComponent,
    ],
    imports: [
...
export class ItemsIfsUpdatedHistoryModule {
}