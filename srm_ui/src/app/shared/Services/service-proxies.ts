...
export class TaskServiceProxy {
    ...
    // private apiTokenworkflow = 'Bearer '+localStorage.getItem('apiTokenworkflow');
    private apiTokenworkflow = 'Bearer '+'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..IL6fV1NQsuKk1D_mgGlhhqiK3DJVXYmfg9GWlbN8pKI';
    ...
    create(input: CreateDocumentDto | null | undefined): Observable<DocumentDto> {
        ...
        let url_ = environment.workflowApiUrl+"/api/services/app/Document/Create";
    ...
    update(input: DocumentDto | null | undefined): Observable<DocumentDto> {
        ...
        let url_ = environment.workflowApiUrl+"/api/services/app/Document/Update";
        url_ = url_.replace(/[?&]$/, "");
        const content_ = JSON.stringify(input);
        let options_ : any = {
            body: content_,
    ...
    delete(id: number | null | undefined): Observable<void> {
        ...
        let url_ = environment.workflowApiUrl+"//api/services/app/Document/Delete?";
        if (id !== undefined)
    ...
    getSchemes(): Observable<SchemeForDocumentOutput[]> {
        ...
        let url_ = environment.workflowApiUrl+"//api/services/app/Document/GetSchemes";
        url_ = url_.replace(/[?&]$/, "");
        let options_ : any = {
            observe: "response",
            responseType: "blob",
    ...
    get(id: number | null | undefined): Observable<DocumentDto> {
        ...
        let url_ = environment.workflowApiUrl+"/api/services/app/Document/Get?";
        ...
        let options_ : any = {
            ...
            headers: new HttpHeaders({
                "Accept": "application/json",
                'Authorization' : 'Bearer '+localStorage.getItem('apiTokenworkflow')
    ...
    getAll(documentName: string | null | undefined, displayName: string | null | undefined, description: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfDocumentDto> {
        ...
        let url_ = environment.workflowApiUrl+"//api/services/app/Document/GetAll?";
    ...
    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfDocumentDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            let resultOutput = new PagedResultDtoOfDocumentDto();
            resultOutput.totalCount = resultData200.result['totalCount'];
            resultOutput.items = [];
            resultData200['result']['items'].forEach(element => {
                let dto = new DocumentDto();
                dto = element;
                resultOutput.items.push(dto);
            });
            result200 = resultData200 ? PagedResultDtoOfDocumentDto.fromJS(resultData200) : new PagedResultDtoOfDocumentDto();
            return _observableOf(resultOutput);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
...
export class DocumentServiceProxy {
    ...
    protected processGet(response: HttpResponseBase): Observable<DocumentDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? DocumentDto.fromJS(resultData200.result) : new DocumentDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
export class WorkflowSchemeServiceProxy {
    ...
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    // private apiTokenworkflow = localStorage.getItem('apiTokenworkflow');
...
//debugger;
    ...
    delete(code: string | null | undefined): Observable<void> {
        let url_ = environment.workflowApiUrl + "/api/services/app/WorkflowScheme/Delete?";
        if (code !== undefined)
    ...
    getAvaliableCommands(processId: string | null | undefined): Observable<WorkflowCommandDto[]> {
        ...
        let url_ = environment.workflowApiUrl+"/api/services/app/WorkflowScheme/GetAvaliableCommands?";
        if (processId !== undefined)
            url_ += "processId=" + encodeURIComponent("" + processId) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAvaliableCommands(response: HttpResponseBase): Observable<WorkflowCommandDto[]> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            if (resultData200 && resultData200.result.constructor === Array) {
                result200 = [];
    ...
    protected processGetSchemes(response: HttpResponseBase): Observable<GetWorkflowSchemesOutput> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            let resultOutput = new GetWorkflowSchemesOutput();
            resultOutput.id = 0;
            resultOutput.schemes = [];
            resultData200['result'].forEach(element => {
                let dto = new WorkflowSchemeDto();
                dto.code = element['scheme'];
                resultOutput.schemes.push(dto);
            });
    ...
    getHistories(processId: string | null | undefined): Observable<WorkflowHistoryDto[]> {
        ...
        let url_ =  environment.workflowApiUrl+"/api/services/app/WorkflowScheme/GetHistories?";
        if (processId !== undefined)
            url_ += "processId=" + encodeURIComponent("" + processId) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
