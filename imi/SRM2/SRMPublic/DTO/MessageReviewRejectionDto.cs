...
{
    public class MessageReviewRejectionDTO
    {
        ...
        public string subject = "Supplier Review Rejection";
        public string reviewer { get; set; }
        public string evaluationName { get; set; }
        public string comment { get; set; }

        public MessageReviewRejectionDTO(IEnumerable<string> to, IEnumerable<string> cc, string reviewSupplierName, string reviewPeriod,
