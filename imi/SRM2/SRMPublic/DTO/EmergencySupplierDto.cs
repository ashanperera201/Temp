...
namespace SRMPublic.DTO
{
    public class EmergencySupplierDto
    {
        ...
        public string emergency_supplier_code { get; set; }
        public string emergency_supplier_name { get; set; }
        ...
        public string srm_remark { get; set; }
        ...
        public string? ifs_pushed_status { get; set; }
